...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "DE GREAT JAPHETH — Premium Building Materials & Finishing" },
      ...
      { property: "og:title", content: "DE GREAT JAPHETH — Premium Building Materials & Finishing" },
      ...
      { name: "twitter:title", content: "DE GREAT JAPHETH — Premium Building Materials & Finishing" },
